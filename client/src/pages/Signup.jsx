        ...
        <div className="min-h-screen w-full bg-slate-50 flex items-center justify-center p-4 font-sans">
            <div className="grid lg:grid-cols-2 w-full max-w-5xl bg-white shadow-2xl rounded-2xl overflow-hidden">
                ...
                <div className="hidden lg:block p-12 bg-gradient-to-br from-indigo-500 to-sky-500 text-white">
                    ...
                    >
                        <h2 className="text-4xl font-bold mb-4">Join SkillMatched Today</h2>
                        <p className="opacity-80 mb-8">
                            Unlock your career potential. Get started with AI-powered resume analysis, personalized roadmaps, and more.
                        </p>
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-3">
                                <CheckCircle className="w-6 h-6 text-green-300" />
                                <span>Discover tailored job roles.</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <CheckCircle className="w-6 h-6 text-green-300" />
                                <span>Get a personalized learning path.</span>
                            </div>
                        </div>
                    </motion.div>
                </div>
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div className="relative">
                                ...
                                <input type="text" placeholder="Full Name" required className="w-full pl-10 pr-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition" />
                            </div>
                            ...
                            <div className="relative">
                                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400" size={20} />
                                <input type={showConfirmPassword ? "text" : "password"} placeholder="Confirm Password" required className="w-full pl-10 pr-12 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition" />
...
// Dummy CheckCircle component for the example
