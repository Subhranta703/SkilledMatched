...
import { buildResumePrompt } from "../utils/prompts.js";
...
router.get("/test", (req, res) => {
  res.json({
    success: true,
    message: "Resume analyzer route is connected.",
  });
});
...
router.post("/analyze", upload.single("resume"), async (req, res) => {
  ...
  try {
    ...
    const prompt = buildResumePrompt(resumeText, role);
...
//   res.json({
//     success: true,
//     message: 'Resume route is connected correctly',
//   });
// });
// 
